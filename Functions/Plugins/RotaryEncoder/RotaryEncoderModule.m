...
classdef RotaryEncoderModule < handle
    ...
    methods
        ...
        function syncParams(obj) % For use when autoSync is off
            SixteenBitMessage = [obj.degrees2pos(obj.leftThreshold) obj.degrees2pos(obj.rightThreshold)];
            obj.Port.write('A', 'uint8', SixteenBitMessage, 'uint16');
        ...
        function Data = getLastTrialData(obj)
            ...
            nPositions = obj.Port.read(1, 'uint16');
            if nPositions > 0
                Data = struct();
                Data.nPositions = double(nPositions);
                [PosData, TimeData] = obj.Port.read(Data.nPositions, 'uint16', Data.nPositions, 'uint32');
